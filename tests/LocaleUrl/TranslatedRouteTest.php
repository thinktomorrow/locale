...
class TranslatedRouteTest extends TestCase
{
    ...
    public function test_it_can_translate_routename_with_param()
    {
    ...
    public function test_it_can_translate_routename_with_optional_param()
    {
    ...
    public function test_it_can_translate_routename_with_multiple_param()
    {
