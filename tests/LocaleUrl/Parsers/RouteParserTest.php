...
class RouteParserTest extends TestCase
{
    ...
    public function test_parser_injects_locale_segment_if_needed()
    {
        $this->assertEquals('http://example.com/first/cow', $this->routeParser->set('route.first', ['slug' => 'cow'])->localize('/', ['/' => 'locale-three'])->get());
    }

    public function test_parser_translates_route_segments_if_provided_via_lang_file()
    {
    ...
    public function test_if_route_translation_is_missing_translation_is_set_in_url()
    {
    ...
    public function test_parser_halts_execution_if_route_is_not_defined()
    {
    ...
    public function test_parser_can_create_a_secure_route()
    {
